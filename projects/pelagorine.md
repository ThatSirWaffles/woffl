...
<h2 style="display: flex; gap: 10px">Pelagorine&nbsp;
...
Previously *Sovereign Shores*. A work-in-progress open-world game, based in medieval times, in an archipelago of individual sovereign islands, all fighting for the upper hand. Currently working on frameworks and terrain generation.
...
<div style="display: flex; gap: 1rem; flex-direction: column; width: 100%">
	...
	<div style="display: flex; gap: 1rem">
		<img src="/assets/images/pelagorine-terrain.png" style="height: 15rem; flex: 1; width: 0; object-fit: cover"/>
		<img src="/assets/images/pelagorine-shipwright.png" style="height: 15rem; flex: 1; width: 0; object-fit: cover"/>
	</div>
	<div style="display: flex; gap: 1rem">
		<video style="height: 15rem; flex: 1; width: 0; object-fit: cover" controls>
			<source src="/assets/videos/pelagorine-npc.mp4" type="video/mp4" />
		</video>
		<video style="height: 15rem; flex: 1; width: 0; object-fit: cover" controls>
			<source src="/assets/videos/pelagorine-ship-demo.mp4" type="video/mp4" />
		</video>
	</div>
</div>
...
*The terrain shown is a semi-final version, reached after several iterations. It is all procedurally generated from a single seed, using fully deterministic algorithms.*|
- First iteration of the ship system|
*Features completely stable physics. Players may walk, run and jump on ships while they are moving, with no risk of falling off.*|
- First iteration of NPC interactions|
*Will be dropped for more diegetic UI, but cool nonetheless*|
